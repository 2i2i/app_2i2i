    ...
    return Scaffold(
      ...
      appBar: CustomAppbar(
          leading: IconButton(
            ...
            onPressed: () => Navigator.of(context).pushNamed(Routes.AppSetting),
              ...
              itemBuilder: (_, ix) {
                ...
                return Card(
                  ...
                  child: ListTile(
                      ...
                      // onTap: () => CustomNavigation.push(context, UserPage(uid: user.id))),
                      onTap: () {
                        Navigator.pushNamed(context,Routes.USER, arguments: {'uid':user.id});
                      },
                  ),
