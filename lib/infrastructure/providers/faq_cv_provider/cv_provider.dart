...
class CVProviderModel extends ChangeNotifier {
  ...
  static List<SuccessData> imiSuccesses = [
    const SuccessData(title: 'Accepted into the Encode Algorand Accelerator', timestamp: 1636934400, tags: [
      'Algorand',
      'Encode',
      '2i2i',
    ], description: '''
...
'''),
    const SuccessData(title: 'Encode Algorand Hackathon 3rd prize', timestamp: 1633500600, tags: [
      'Algorand',
      'Encode',
      '2i2i',
      'award',
...
'''),
    const SuccessData(
        title: 'Automated online lending system', timestamp: 1569888000, tags: ['GCP', 'app', 'javascript', 'vue', 'CTO', 'IT', 'finance'], description: '''
...
'''),
    const SuccessData(
        title: 'Quasi Monte Carlo with PCA implementation', timestamp: 1433116800, tags: ['Monte Carlo', 'julia', 'C#', 'math', 'PCA', 'Axpo'], description: '''
...
'''),
    const SuccessData(
        title: 'Heston stochastic vol model implemetation', timestamp: 1293840000, tags: ['UBS', 'C++', 'Heston', 'math', 'finance'], description: '''
• Implementated and wrote a white paper on a Heston stochastic volatility model to evaluate complex financial products.
• Implementated in C++.
• Work done for UBS.
'''),
    const SuccessData(
        title: 'Centralised Smart contracts', timestamp: 1275350400, tags: ['UBS', 'smart contract', 'math', 'Monte Carlo', 'Lua', 'finance'], description: '''
...
• I quit university for personal reasons after this.
            '''),
    const SuccessData(
        title: 'Won a pattern recognition competition run by Prof. Ziegler', timestamp: 986083200, tags: ['math', 'ML', 'AI', 'award'], description: '''
...
'''),
    const SuccessData(
        title: 'Coded system to archive incoming fax as digital documents', timestamp: 988675200, tags: ['C++', 'windows', 'linux'], description: '''
...
After getting the visa, arriving, getting a car, a house, I consider this a success.
    ...
    const SuccessData(
        ...
        description: '''Won numerous awards  in the Essay category, Fiction category, and Poetry category.'''),
    const SuccessData(
        title: 'Art Awards',
        timestamp: 1007078400,
        tags: ['award', 'art'],
        description: '''Won prizes in calligraphy categories , fine art and design in various competitions.'''),
    const SuccessData(
        title: 'Teaching',
