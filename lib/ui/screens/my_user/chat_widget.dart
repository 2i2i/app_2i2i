...
class _ChatWidgetState extends ConsumerState<ChatWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return FittedBox(
      ...
      child: Container(
        height: kIsWeb?844:MediaQuery.of(context).size.width,
        width: kIsWeb?500:MediaQuery.of(context).size.width,
        margin: EdgeInsets.only(top: kToolbarHeight + 12, right: 8, left: 8, bottom: 12 + MediaQuery.of(context).viewInsets.bottom),
