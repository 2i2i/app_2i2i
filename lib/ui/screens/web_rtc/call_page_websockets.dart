...
class CallPageWebsockets extends StatefulWidget {
  static String tag = 'call_sample';
  final String host;
  CallPageWebsockets({required this.host});

  @override
  _CallPageWebsocketsState createState() => _CallPageWebsocketsState();
}

class _CallPageWebsocketsState extends State<CallPageWebsockets> {
  ...
  void _connect() async {
    _signaling ??= SignalingWebSockets(widget.host)..connect();
