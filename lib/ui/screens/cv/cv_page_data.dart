...
'''),
    const SuccessData(title: 'Machine Learning based system to calculate microfinancing credit risk', timestamp: 1575158400, description: '''
...
'''),
    const SuccessData(title: 'Automated online lending system', timestamp: 1569888000, description: '''
...
'''),
    const SuccessData(title: 'Quasi Monte Carlo with PCA implementation', timestamp: 1433116800, description: '''
...
'''),
    const SuccessData(title: 'Web app using .NET', timestamp: 1451606400, description: '''
...
'''),
    const SuccessData(title: 'Prophet: A system to run server models in various languages', timestamp: 1420070400, description: '''
...
'''),
    const SuccessData(title: 'Fully automated financial trades execution system', timestamp: 1420070400, description: '''
...
// Each of which is based on economic and financial maths theory. All strategies are out-of-sample tested over decades of data.
    const SuccessData(title: 'Fully automated trading system', timestamp: 1420070400, description: '''
...
'''),
    const SuccessData(title: 'Private video chat web app using WebSockets', timestamp: 1435708800, description: '''
...
'''),
    const SuccessData(title: 'GPU computing implementations', timestamp: 1370044800, description: '''
...
'''),
    const SuccessData(title: 'Implementation of a quantitative trading system', timestamp: 1333238400, description: '''
• Implemenation of several trading models in Matlab.
• A portfolio and trades management system in Matlab.
            '''),
    const SuccessData(title: 'Fully automated financial trades execution system', timestamp: 1330560000, description: '''
• Implemenation of a trades execution system in C#.
• A C# GUI to admin the system.
• Connected to CQG and IB.
            '''),
    const SuccessData(title: 'Novel model for portfolio optimization with significant performance improvement', timestamp: 1338508800, description: '''
...
'''),
    const SuccessData(title: 'Heston stochastic vol model implemetation', timestamp: 1293840000, description: '''
• Implementated and wrote a white paper on a Heston stochastic volatility model to evaluate complex financial products.
• Implementated in C++.
• Work done for UBS.
'''),
    const SuccessData(title: 'Centralised Smart contracts', timestamp: 1275350400, description: '''
...
'''),
    const SuccessData(title: 'Flights meta search', timestamp: 1243836600, description: '''
...
'''),
    const SuccessData(title: 'System to beat a Casino', timestamp: 1159660800, description: '''
...
'''),
    const SuccessData(title: 'Achieved 1.0 in Math Vordiplom', timestamp: 1054425600, description: '''
...
• I quit university for personal reasons after this.
            '''),
    const SuccessData(title: 'Won a pattern recognition competition run by Prof. Ziegler', timestamp: 986083200, description: '''
...
'''),
    const SuccessData(title: 'Coded system to archive incoming fax as digital documents', timestamp: 988675200, description: '''
• On arriving fax, the system saved and archived the document digitally.
• Written for Carano Software, Berlin.
            '''),
    const SuccessData(title: 'Coded neural network for audio vowel classification incl. GUI for admin', timestamp: 993945600, description: '''
...
'''),
    const SuccessData(title: 'Attended and passed Analysis at uni during high school', timestamp: 904608000, description: '''
...
I did the homework, passed the courses and received the credit which I could have used later.
            '''),
    const SuccessData(title: 'Ski teacher certification', timestamp: 838857600, description: '''
...
Yet, I did enjoy it and skiied so much in the two years before these exams, that I made it. Barely, but I made it.
            '''),
    const SuccessData(title: 'German U18 water polo champion', timestamp: 928195200, description: '''
...
'''),
    const SuccessData(title: 'Coded graphical labyrinth game', timestamp: 825638400, description: '''
...
I even remember coding and formatting my computer without a screen, which my mother took away, thinking that was the computer. That is how intimate I was with my computer. I knew what it was doing based on my commands and the sounds it would make.
            '''),
    const SuccessData(title: 'Jumped from German D4 to D1 within 2 years', timestamp: 841536000, description: '''
...
Nonetheless, I count it as a sucesss.
            '''),
    const SuccessData(title: 'Self derived formula to calculate curve length', timestamp: 786240000, description: '''
...
After deriving and applying the formula, I tested the result vs an applied maths app. The result matched and this achievement became my proudest.
            '''),
    const SuccessData(title: 'Skipped grades 3 and 4', timestamp: 683683200, description: '''
...
I always count it as a success, just because I did not like school. Though now, I am not sure whether it was a good idea and am not sure whether to advise the same for others in a similar situation.
            '''),
    const SuccessData(title: 'Won neighbourhood chess championship', timestamp: 688953600, description: '''
...
I did earn pocket money over many years to come.
            '''),
    const SuccessData(title: 'Raised 8MM CHF for ecamos', timestamp: 1370044800, description: '''
...
Since I geniunely dislike 'selling' anything, this was an achievement outside my comfort zone, begotten via a year long correspondence with the client.
            '''),
    const SuccessData(title: 'Worked at UBS QRC', timestamp: 1249084800, description: '''
...
Against all odds, I got the job. I would go on to get a 'record time' promotion, aparently 'unheard of', after less than 6 months at UBS, during the height of the 2009 financial crisis.
            '''),
    const SuccessData(title: 'EUREX Exchange Trader Examination', timestamp: 1267401600, description: '''
Passed the exam.
            '''),
    const SuccessData(title: 'Financial Risk Management Certification (GARP)', timestamp: 1262649600, description: '''
...
'''),
    const SuccessData(title: 'Winner of Swiss ‘Quiz on Korea 2013’', timestamp: 1370044800, description: '''
...
This made me the Swiss representative at the international 'Quiz on Korea' world championships in Seoul. I did not do well at the finals, but still consider it a success to have made it that far.
            '''),
    const SuccessData(title: 'Intercontinental move to Canada', timestamp: 1627862400, description: '''
...
Relevantly, this entry provides an anchor in time to contextualize the other successes.
            '''),
    const SuccessData(title: 'Accepted into the Encode Algorand Accelerator', timestamp: 1636934400, description: '''
Using the accelerator, we matured the concept of 2i2i and released the test version on the Algorand testnet (test.2i2i.app).
We believe that we have developed an efficient market system to allow everyone in the world to realise their true value.
We are working on the patent and on bringing the app to mainnet and to release a governance token and to offer a fiat on-ramp.
'''),
    const SuccessData(title: 'Encode Algorand Hackathon 3rd prize', timestamp: 1633500600, description: '''
Encode is an organisation that helps with the adoption of blockchains by running courses and hackathons.
It felt like the ideal framework to try to implement a project that I wanted to pursue: 2i2i, the place to hang out based on Algorand.
After intense weeks of hard work, we delivered the project very last minute and succeeded in making it into the finale.
'''),
...
After getting the visa, arriving, getting a car, a house, I consider this a success.
            '''),
    const SuccessData(
        title: 'Writing Awards', timestamp: 1070150400, description: '''Won numerous awards  in the Essay category, Fiction category, and Poetry category.'''),
    const SuccessData(
        title: 'Art Awards', timestamp: 1007078400, description: '''Won prizes in calligraphy categories , fine art and design in various competitions.'''),
    const SuccessData(
        title: 'Teaching',
        timestamp: 1196380800,
        description: '''With a sense of vocation and duty,  taught children from age 8—19that they can learn while having fun.
Jungchul Pro - 
Dasung - 
...
Led the customs clearance without a hitch by translating the proper etiquette for the strict censorship of the Ministry of Food and Drug Safety.'''),
    const SuccessData(
        title: 'Exporting Products', timestamp: 1512000000, description: '''Supply European (Germany, Switzerland) manufactured products to Korean buyers
        ...
        children: [
          ListView.builder(
            ...
            itemBuilder: (BuildContext context, int index) {
              ...
              return Success(data: successDataList[index], backgroundColor: backgroundColor);
            },
          ),
          ListTile(
            title: Text(
