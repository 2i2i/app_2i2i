...
class en {
  Map data() {
    return {
      ...
      Keys.noRedeemCoinsFound: 'No redeem coin availale',
      ...
      Keys.loginMsg: 'receive energy by talking',
      Keys.loginMsg2: '2i2i provides a safe and private space for users to meet whilst receiving coins',
      Keys.loginMsg3: 'MEETINGS SINCE LAUNCH',
      ...
      Keys.okay: 'Okay',
      Keys.connectedSocialAccount: 'Connected with social account',
      Keys.zero: 'zero',
      Keys.minutes: 'minutes',
      Keys.hours: 'hours',
      Keys.days: 'days',
      Keys.weeks: 'weeks',
      Keys.months: 'months',
      Keys.years: 'years',
      Keys.thisIsYou: 'This is you',
      Keys.deleteAccount: 'Delete account',
      Keys.deleteAccountMessage: 'Are you sure want to delete your account permanently from 2i2i?',
      Keys.estMaxDuration: 'Max Duration',
      Keys.waitTimeMsg: 'Est. Wait time is',
      Keys.writeComment: 'Write a comment...',
      Keys.connecting: 'Connecting...',
      Keys.muted: 'Muted',
      Keys.connect: 'Connect',
      Keys.receiveSendCoin: 'Please first connect an account to send/receive energy.',
      ...
      Keys.walletDesMsg2: 'You have connected an account. Now you can receive energy. Click Talk to connect with your Guest.',
